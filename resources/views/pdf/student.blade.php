...
<ol>
    ...
    <li>Дата поступления в ДШИ (приказ) {{$begin_at}}: {{$begin_doc_number}}</li>
    ...
    <li>Дата и причина отчисления из ДШИ {{$end_at}}</li>
    <li>Номер приказа об отчислении {{$end_doc_number}}</li>
