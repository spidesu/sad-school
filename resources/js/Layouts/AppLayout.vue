                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="flex-shrink-0 flex items-center">
                            <inertia-link :href="route('students')">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            <jet-nav-link :href="route('representatives')" :active="route().current('representatives')">
                                Представители
                            </jet-nav-link>
                            <jet-nav-link :href="route('students')" :active="route().current('students')">
                                Ученики
                            </jet-nav-link>
                            <jet-nav-link :href="route('teachers')" :active="route().current('teachers')">
                                Преподаватели
                            </jet-nav-link>
                            <jet-nav-link :href="route('departments')" :active="route().current('departments')">
                                Отделения
                            </jet-nav-link>
                            <jet-nav-link :href="route('groups')" :active="route().current('groups')">
                                Группы
                            </jet-nav-link>
                            <jet-nav-link :href="route('dictionaries')" :active="route().current('dictionaries')">
                                Словари
                            </jet-nav-link>
                            <jet-nav-link :href="route('schedules')" :active="route().current('schedules')">
                                Расписание
                            </jet-nav-link>
                            <jet-nav-link :href="route('reports')" :active="route().current('reports')">
                                Отчеты
                            </jet-nav-link>
                            <jet-nav-link :href="route('sheets')" :active="route().current('sheets')">
                                Ведомости
                            </jet-nav-link>
